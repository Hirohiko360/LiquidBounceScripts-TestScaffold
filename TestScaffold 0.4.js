...
function TestScaffold() {
    ...
    var settings = {
        ...
        bindtower: setting.boolean("BindTower", false),
        buildHand: setting.boolean("BuildHand", false),
        tower: setting.boolean("Tower", false),
        autojump: setting.boolean("AutoJump", false),
