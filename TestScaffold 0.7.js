...
function TestScaffold() {
    ...
    var settings = {
        ...
        towermode: setting.list("TowerMode", ["TestTower", "BindTower", "AACTower"], "TestTower"),
        motionground: setting.boolean("MotionGround", false),
        speed: setting.boolean("Speed", false),
        speedmode: setting.list("SpeedMode", ["AutoJump", "BindSpeed", "TestSpeed", "TestSpeed2", "TestHop", "AACTestSpeed", "AACTestSpeed2"], "AutoJump"),
        // Visuals
