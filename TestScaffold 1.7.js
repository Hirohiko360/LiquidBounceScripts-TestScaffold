...
// Classification List 
var choose = ["World", "Fun", "Movement", "Render", "Combat", "Player", "Misc", "Exploit"];
var chooseset = JOptionPane.showOptionDialog(null,"请选择分类列表(Please select a classification list)：","分类列表选择(Category list selection)",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE,null,choose,choose[0]);
