...
function TestScaffold() {
    ...
    var settings = {
		...
		horse: setting.boolean("TestRotations-IfHorse", true),
		rotationYaw: setting.integer("RotationYaw", 90, 0, 360),
		rotationPitchHead: setting.integer("RotationPitchHead", 90, 0, 360),
		renderYawOffset: setting.integer("RenderYawOffset", 90, 0, 360),
		rotationYawHead: setting.integer("RotationYawHead", 90, 0, 360),
		ridingEntity: setting.integer("RidingEntity", 90, 0, 360),
